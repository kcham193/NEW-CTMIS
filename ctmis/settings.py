...
ALLOWED_HOSTS = ['*',
                 "ctmis.online",
                 "www.ctmis.online",  # optional but good to add
                 "127.0.0.1",  # if you use localhost for testing
                 ]
...
DATABASES = {
     'default': {
         ...
         'HOST': 'backendcourse.cjga6umsy394.eu-north-1.rds.amazonaws.com',  # Replace with your PostgreSQL server's address if necessary
